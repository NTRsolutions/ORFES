...
<script src="<?php echo base_url(); ?>assets/js/jquery.confirm.min"></script>

<script type="text/javascript">
//    var method = 'check_data';
//    var controller = 'restaurant';
    var base_url = '<?php echo site_url(); //you have to load the "url_helper" to use this function            ?>';
    function jquery_ajax_search(controller, method, type) {
        $.ajax({
            ...
            'success': function (data) { //probably this request will return anything, it'll be put in var "data"
                var container = $('#search_result'); //jquery selector (get element by id)
                if (data) {
                    container.html(data);
                }
            }
